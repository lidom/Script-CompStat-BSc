...
* a (univariate) normal distribution assumptions, i.e. $X_j|Y=k \sim N(\mu_{jk},\sigma_{jk})$
...
where the different estimation approaches can differ for each $j=1,\dots,p.$
