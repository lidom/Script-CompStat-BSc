...
We have seen above, that estimating the prior probabilities $\pi_1,\dots,\pi_K$ is typically straight forward using 
$$
...
f_1(x),\dots,f_K(x)
$$ 
is substantially more difficult. To make estimation tractable and useful, LDA and QDA assume parametric families for these density functions; namely, multivariate normals with and without common covariances.  
