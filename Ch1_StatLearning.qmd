...
\end{align*}
are called the **Bayes decision boundary**. (Likewise for more than two class labels.) An example of a Bayes decision boundary is shown as the purple dashed line in Fig. 2.13.

![](images/Fig_2_13.png)

* Note to Fig. 2.13: Here, a perfect classification of a zero classification error rate is impossible, since the Bayes decision boundary does not partition the two groups (yellow, blue) in to complete separate groups. 
