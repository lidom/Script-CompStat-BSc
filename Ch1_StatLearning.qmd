...
Figures 2.9 to 2.11 shows training and test MSEs for estimates $\hat{f}$ for $f$ with varying complexities and different signal-to-noise ratios $Var(f(X))/Var(\epsilon)$. 
