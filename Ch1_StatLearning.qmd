...
Thus, fitting the noise (irreducible component) in the training data will typically lead to bad approximations of new observations from a test data set. 
...
Then, the **point-wise test MSE** at $x_0$ is given by,
\begin{align*}
...
One can show that the expected test MSE can be decomposed as following: 
\begin{align*}
