...
Reading: Chapter 2 of our course textbook `ISLR` [An Introduction to Statistical Learning](https://www.statlearning.com/), by Gareth James, Daniela Witten, Trevor Hastie, and Robert Tibshirani
...
The training (data) MSE is given by
\begin{align*}
...
$$
denote the set of $m$ test data points. Then, the test MSE is given by,
\begin{align*}
