...
$$
If this were true, we could simply generate a new dataset containing new observations for $X$ and $Y$ that allow us to compute a new estimate $\hat\alpha.$ 

Repeating this, for instance, $B=1000$ many times would give as $B=1000$ estimates  
$$
...
Indeed, by the law of large numbers this sample standard deviation consistently estimates the true $\operatorname{SE}(\hat\alpha)$ as $B\to\infty.$ 

Some codes for doing this:


But, unfortunately, this depends on our unrealistic assumption that we know the population distribution of $(X,Y),$ which makes this approach infeasible in practice. 😭
