...
Thus, the bootstrap estimate of the standard error $\operatorname{SE}(\hat\alpha)$ should be close to the practically infeasible Monte Carlo estimate of the standard error, even though the bootstrap method does not explicitly use the true data generating process, but only the observed data.  
