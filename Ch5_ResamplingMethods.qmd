...
## "sub"-sample size of each hold-out test data set
n_sub          <- floor(n/k)

## auxiliary vector for selecting the test/validation-datasets
test_data_slct <- c(0, n_sub * 1:(k-1), n)

## Save starting time of the loop
start_time     <- Sys.time()

for(r in 1:k){
  fold_pos      <- (test_data_slct[r]+1):test_data_slct[r+1]
  ## Training set 
