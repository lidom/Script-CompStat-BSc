...
$$
\epsilon_i\overset{\text{iid}}{\sim}\mathcal{N}(0,1),,\quad i=1,\dots,n_{Train},
$$
...
(b) Compute the KNN-Regression estimation for $K=5$ and a *dense* $x$-grid between 0 and 1 (e.g. `seq(0,1,len=1000)`) and compare the results with the true regression function values using a plot.
