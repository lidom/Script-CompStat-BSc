...
(a) Programm KNN-Regression Estimator $\hat{f}_K(x_0).$ Compute the KNN-Regression estimation $\hat{f}_K(x_0)$ for $K=5$ and $x_0 = 0.2.$ Compare the result with the true regression function value $f(0.2).$
