...
(a) What is the bias of $\hat\beta=(\hat\beta_0,\hat\beta_1)^\top$?
(b) What are the standard errors $\operatorname{SE}(\hat\beta_0|X)$ and $\operatorname{SE}(\hat\beta_1|X)$?
(c) Generate $10000$ realizations of the estimator $\hat\beta$ by repeatedly drawing independent realizations form the data generating process. 
   * What is the sample mean of these $10000$ estimates? Does this result fit to the theoretical bias result? 
   * What is the sample sdandard deviation of these $10000$ estimates? Does this result fit to the theoretical standard error result? 
