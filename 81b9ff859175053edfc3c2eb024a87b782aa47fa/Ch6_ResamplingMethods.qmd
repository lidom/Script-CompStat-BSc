...
$$
\widehat{\operatorname{MSE}}_{Train,1}, 
\widehat{\operatorname{MSE}}_{Train,2},\dots,
\widehat{\operatorname{MSE}}_{Train,k},
$$
where
$$
\begin{align*}
\widehat{\operatorname{MSE}}_{Train,j}
...
$$
\operatorname{CV}_{(k)}=\frac{1}{k}\sum_{j=1}^k\widehat{\operatorname{MSE}}_{Train,j}
$${#eq-kfoldCV}
