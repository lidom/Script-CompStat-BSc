...
* $Y_i$ is called "dependent variable" or "outcome variable" or "regressand" * $X_{ik}$ is called the $k$th "predictor variable" or "regressor" or "explanatory variable" or "control variable." 
