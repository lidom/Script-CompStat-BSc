...
**Assignment Task Nr. 1:** 

* Use the above given data generating process to generate $B=100000$ OLS estimates of the true (usually unknown) parameter vector $\beta'=(\beta_0,\beta_1).$ Use two boxplot (one for the estimates of $\beta_0$ and another for those of $\beta_1$) to visualize the estimates.  
* Check the bias of the OLS estimator for the above given data generating process using the above described simulation approach (Monte Carlo simulation). 
* Given your simulaiton result, can you state that the OLS estimatior is generally biased/unbiased? 


<!-- **Assignment Task Nr. 2:** -->
