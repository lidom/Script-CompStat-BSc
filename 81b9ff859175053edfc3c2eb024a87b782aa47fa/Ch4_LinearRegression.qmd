...
**A small value for $K$** provides the most flexible fit, which will have 
   ...
   * low bias 
    $$
    |\operatorname{Bias}(\hat{f}(x_0))| = |E(\hat{f}(x_0)) - f(x_0)| \;\text{ is small}
    $$
   * high variance
    $$
    Var(\hat(f)(x_0))  \;\text{ is large}
    $$ 
...
**A large value of $K$** provides a less flexible fit, which will have 
   ...
   * large bias
    $$
    |\operatorname{Bias}(\hat{f}(x_0))| = |E(\hat{f}(x_0)) - f(x_0)| \;\text{ is large}
    $$ 
   * low variance
    $$
    Var(\hat(f)(x_0))  \;\text{ is small}
    $$ 
